...
public abstract class DbHelper
{
    ...
    public static int ExecuteNonQuery(CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
    {
        ...
        return ExecuteNonQuery(connectionSetting.ConnectionString, cmdType, cmdText, commandParameters);
    }
    ...
    {
        ConnectionStringSettings connectionSetting = ConfigurationManager.ConnectionStrings["DB"];
        return ExecuteReader(connectionSetting.ConnectionString, cmdType, cmdText, commandParameters);
    }
    ...
    {
        ConnectionStringSettings connectionSetting = ConfigurationManager.ConnectionStrings["DB"];
        return ExecuteScalar(connectionSetting.ConnectionString, cmdType, cmdText, commandParameters);
    }
    ...
    {
        ConnectionStringSettings connectionSetting = ConfigurationManager.ConnectionStrings["DB"];
        return ExecuteTable(connectionSetting.ConnectionString, cmdType, cmdText, commandParameters);
    }
    ...
    /// <param name="PageCount">输出参数，返回查询的总页数</param>
    /// <returns>返回查询结果</returns>
    public static DataTable ExecutePageNew(string SqlAllFields, string SqlTablesAndWhere, string IndexField, string OrderFields, int PageIndex, int PageSize, out int RecordCount, out int PageCount, params DbParameter[] commandParameters)
    {
        ConnectionStringSettings connectionSetting = ConfigurationManager.ConnectionStrings["DB"];
        return ExecutePage(connectionSetting.ConnectionString, SqlAllFields, SqlTablesAndWhere, IndexField, OrderFields, PageIndex, PageSize, out RecordCount, out PageCount, commandParameters);
    }
