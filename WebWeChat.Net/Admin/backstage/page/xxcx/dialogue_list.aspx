<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialogue_list.aspx.cs" Inherits="WebWeChat.Net.Admin.backstage.page.xxcx.dialogue_list" %>
    ...
    <script>
        ...
        $(function () {
            ...
            var settings = {
                ...
                "ajax": {
                    "url": "/XxcxManage/GetDialogueList",
                    "type": "POST",
                    "dataType": "json",
            ...
            $("body").delegate(".delBtn", "click", function () {
                ...
                layer.confirm('确认是否删除？', {
                    ...
                    $.ajax({
                        async: true,
                        type: "POST",
                        url: "/XxcxManage/DeleteDialogueById",
                        data: { "id": id },
