<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WebWeChat.Net.Admin.backstage.index" %>

<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>XX医院诊疗辅助咨询系统——管理员管理</title>
    ...
    <link rel="stylesheet" type="text/css" href="css/larryms.css" media="all">
	<!-- load css -->
    <script>
        /^http(s*):\/\//.test(location.href) || alert('larryMS提示您 请先部署到 localhost 下再访问！！！');
    </script>
</head>
<body>
                  ...
                  <%--  <li class="layui-nav-item" lay-unselect>
                   ...
                   <%-- <li class="layui-nav-item" lay-unselect>
            		...
            		<li class="layui-nav-item exit" lay-unselect>
                        <a id="logout" data-url='../Logout.aspx'><i class="larry-icon larry-exit"></i><cite>退出</cite></a>
                    </li>
            	</ul>
            </div>
        </div>
		...
		<div class="layui-side pos-a larryms-left layui-bg-black" id="larry_left">
			<div class="layui-side-scroll">
                ...
                <div class="user-info">
                    ...
                    <p><span id="uname"><%=Session["nickname"] %></span>您好！欢迎登录</p>
                </div>
                <!-- 系统菜单 -->
...
<script type="text/javascript">
    layui.cache.menusUrl = '<%=menu_url%>';//这里设置 菜单数据项接口地址 或data参数
